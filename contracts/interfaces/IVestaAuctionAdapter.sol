...
///
/// @dev clearingPrice() returns a Q96 fixed-point value (token/currency * 2^96) as emitted
///      by the CCA.  The liquidity adapter is responsible for converting Q96 to sqrtPriceX96
///      before calling Uniswap v4 PoolManager.
interface IVestaAuctionAdapter {
    ...
    /// @notice Returns the final clearing price in Q96 format (token/currency * 2^96).
